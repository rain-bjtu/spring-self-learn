...
public class Main {
    ...
    public static final InputStream INPUT = Main.class.getResourceAsStream("app.properties");
    ...
    public void testGetResource() {
        ...
        System.out.println(Main.class.getClassLoader().getResource("resource/and/property").getPath());
        System.out.println(Main.class.getClassLoader().getResource("resource/and/property/app.properties").getPath());
    }
